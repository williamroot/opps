...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Config.feed_publishable'
        db.add_column(u'core_config', 'feed_publishable',
                      self.gf('django.db.models.fields.BooleanField')(default=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Config.feed_publishable'
        db.delete_column(u'core_config', 'feed_publishable')
    ...
    models = {
        ...
        u'channels.channel': {
            ...
            'feed_publishable': ('django.db.models.fields.NullBooleanField', [], {'default': 'True', 'null': 'True', 'blank': 'True'}),
