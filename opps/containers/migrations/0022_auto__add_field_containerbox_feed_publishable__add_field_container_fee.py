...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContainerBox.feed_publishable'
        db.add_column(u'containers_containerbox', 'feed_publishable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Container.feed_publishable'
        db.add_column(u'containers_container', 'feed_publishable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContainerBox.feed_publishable'
        db.delete_column(u'containers_containerbox', 'feed_publishable')

        # Deleting field 'Container.feed_publishable'
        db.delete_column(u'containers_container', 'feed_publishable')
