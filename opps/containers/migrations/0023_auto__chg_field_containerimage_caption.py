...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContainerImage.caption'
        db.alter_column(u'containers_containerimage', 'caption', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'ContainerImage.caption'
        db.alter_column(u'containers_containerimage', 'caption', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
