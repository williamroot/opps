...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.feed_publishable'
        db.add_column(u'channels_channel', 'feed_publishable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.feed_publishable'
        db.delete_column(u'channels_channel', 'feed_publishable')
