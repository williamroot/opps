...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.msn_publishable'
        db.add_column(u'articles_post', 'msn_publishable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.msn_publishable'
        db.delete_column(u'articles_post', 'msn_publishable')
    ...
    models = {
        ...
        u'articles.post': {
            ...
            'headline': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'msn_publishable': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'short_title': ('django.db.models.fields.CharField', [], {'max_length': '140', 'null': 'True', 'blank': 'True'})
        },
