...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuerySet.feed_publishable'
        db.add_column(u'boxes_queryset', 'feed_publishable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuerySet.feed_publishable'
        db.delete_column(u'boxes_queryset', 'feed_publishable')
